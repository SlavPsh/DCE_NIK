...
#SBATCH --mem 32G
#SBATCH -t 1:30:00
# grasp pro on the phantom through the library pathway at K 5, 25 spokes/frame (68 frames), same 5 of 7 spokes; then the story figures with it (tag _prok5) and the in vivo panel with curve nrmse
