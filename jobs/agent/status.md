...
updated 2026-09-22 02:20:18 on worker03.cluster, job 3346526, cycle 197

## active

| jid | script | state |
|---|---|---|
| 3347079 | 063_production | 1 PENDING QOSMaxGRESPerUser, 1 RUNNING None |

## done (last 20)

| name | state |
|---|---|
| 063_production | 1 PENDING QOSMaxGRESPerUser, 1 RUNNING None |
