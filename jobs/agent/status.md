...
updated 2026-09-18 01:47:46 on worker09.cluster, job 3317310, cycle 119

## active

| jid | script | state |
|---|---|---|
| 3319931 | 053_ctv_rerun | 1 RUNNING None |
| 3320104 | 055_kspace_priors | 1 PENDING MaxGRESPerAccount, 1 RUNNING None |

## done (last 20)

| name | state |
|---|---|
| 053_ctv_rerun | 1 RUNNING None |
| 055_kspace_priors | 1 PENDING MaxGRESPerAccount, 1 RUNNING None |
