...
slice number burnt in the corner. paint pure red (liver), green (spleen), blue (aorta) over a copy and save as rois_manual/<ds>_sl<Z>.png.
...
out = f"/net/beegfs/users/P101440/DCE_NIK/rois_manual"; os.makedirs(out, exist_ok=True)
