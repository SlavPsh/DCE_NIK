...
for S in 0 1 2; do sbatch --gres=gpu:4g.47gb:1 --export=ALL,MODEL=wire_ff_subspace,RANK=5,WS=1,W=768,SEED=$S sbatch_xph_img.sh; done
sbatch --gres=gpu:2g.24gb:1 --export=ALL,MODEL=wire_ff,RANK=0,WS=0,W=768,SEED=0 sbatch_xph_img.sh
