...
CONFIGS=(
    config/mct_dcfalpha_dcfoff_a0p5.toml
    config/mct_dcfalpha_dcfoff_a1p0.toml
    config/mct_dcfalpha_dcfoff_a1p5.toml
    config/mct_dcfalpha_dcfon_a0p5.toml
    config/mct_dcfalpha_dcfon_a1p0.toml
    config/mct_dcfalpha_dcfon_a1p5.toml
)
